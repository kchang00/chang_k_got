(() => {
	...
	function animateBanner() {
		...
		// if (houseName.textContent == `House ${houseData[0][0]}`) {
		// 	houseInfo.textContent = houseData[0][1];
		// }
		// else if (houseName.textContent == `House ${houseData[0][1]}`) {
		...
		//change house name --> will only be Stark name (need to figure out how to change it)
		houseName.textContent = `House ${houseData[0][0]}`;

		//change the house content --> this will only ever be Stark House data (need to figure out how to change it)
		houseInfo.textContent = houseData[0][1];
